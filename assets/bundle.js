(function () {
...
})()(
  {
    1: [
        ...
        class Creature {
          ...
          decreaseNeeds() {
            for (const need of Object.keys(this.needs)) {
              const decreaseAmount =
                this.needs[need] - NEEDS[need].decreaseAmount;
          ...
          doAction(tilesInArea) {
            ...
            if (path.length === 0) {
              ...
              if (path.length === 0) {
                console.log(
                  "soif de creature avant gloup:" + this.needs.THIRST
                );
                this.increaseNeed(criticalNeed, targetType);
                console.log(
                  "soif de creature apers gloup :" + this.needs.THIRST
                );
                return true;
              }
            }
      ...
      { "../utils/constants.js": 7, "../utils/shortestPathAlgo.js": 9 },
    ],
    2: [
      function (require, module, exports) {
        ...
        class GameEngine {
          ...
          start() {
            ...
            if (this.players.length < 1 || this.players.length > 4) {
              throw new Error(
                "Vous devez mettre une liste de 1 à 4 joueurs !!!"
              );
            }
...
function currentTile(creature, listTile) {
  ...
  for (let tile of listTile) {
    if (creature.x == tile.x && creature.y == tile.y) {
      ...
      { "../utils/constants.js": 7, "./creature.js": 1, "./grid.js": 3 },
    ],
    3: [
      function (require, module, exports) {
            ...
            while (cpt < nbOfTilesToCreate) {
              ...
              if (tile.type == TILE_TYPES.DIRT) {
                ...
                if (type == TILE_TYPES.WATER) {
                  ...
                  const waterTiles = this.getWaterShape(
                    tile,
                    remainingWaterSize
                  );
...
*/
      ...
      { "../utils/constants.js": 7, "./tile.js": 5 },
    ],
    4: [
      function (require, module, exports) {
        class Player {
    ...
    5: [
      function (require, module, exports) {
        ...
        class Tile {
          ...
          isObstacle() {
            return (
              this.type == TILE_TYPES.ROCK || this.type == TILE_TYPES.WATER
            );
          }
...
*/
      ...
      {
        "./components/gameEngine.js": 2,
        "./components/player.js": 4,
        "./utils/fetchData.js": 8,
        "./views/menu.js": 10,
      },
    ],
    7: [
    ...
    8: [
      function (require, module, exports) {
        function fetchData() {
          const nbOfPlayer = parseInt(
            document.getElementById("nbOfPlayer").value
          );
          const players = [];
