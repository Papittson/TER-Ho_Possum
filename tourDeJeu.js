...
function action(creature) {
        ...
        if (creature.needsLevel.sleep < seuilDodo && localisationCase("shed", creature)){sleep(creature); return}
        if (creature.needsLevel.sleep < seuilDodo){search("shed", creature); return}
